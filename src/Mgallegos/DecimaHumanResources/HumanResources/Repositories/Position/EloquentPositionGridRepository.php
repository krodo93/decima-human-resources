...
class EloquentPositionGridRepository extends EloquentRepositoryAbstract {
	...
	public function __construct(DatabaseManager $DB, AuthenticationManagementInterface $AuthenticationManager)
	{
		...
		$this->visibleColumns = array('t1.id AS hr_position_id',
																	't1.name AS hr_position_name',
																	't1.salary AS hr_position_salary',
