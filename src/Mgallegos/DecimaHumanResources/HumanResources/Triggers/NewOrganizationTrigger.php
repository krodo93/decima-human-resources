 ...
 */
namespace Mgallegos\DecimaHumanResources\HumanResources\Triggers;
...
use Mgallegos\DecimaHumanResources\HumanResources\Repositories\Setting\SettingInterface;
...
class NewOrganizationTrigger implements NewOrganizationTriggerInterface {
	...
	* Setting
	*
	* @var Mgallegos\DecimaHumanResources\HumanResources\Repositories\Setting\SettingInterface
	*
	*/
	protected $Setting;
