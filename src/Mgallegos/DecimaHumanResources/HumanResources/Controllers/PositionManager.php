...
class PositionManager extends Controller {
	...
	*/
	...
	public function __construct(PositionManagementInterface $PositionManagerService,
	...
	{
		return $this->View->make('decima-human-resources::position-management')
						->with('newPositionAction', $this->Session->get('newPositionAction', false))
						->with('editPositionAction', $this->Session->get('editPositionAction', false))
						->with('deletePositionAction', $this->Session->get('deletePositionAction', false))
						//->with('accounts', $this->PositionManagerService->getGroupsAccounts())
	...
	{
		return $this->PositionManagerService->getGridData( $this->Input->all() );
	}

	public function postCreate()
	{
		return $this->PositionManagerService->create( $this->Input->json()->all() );
	}

	public function postUpdate()
	{
		return $this->PositionManagerService->update( $this->Input->json()->all() );
	}

	public function postDelete()
	{
		return $this->PositionManagerService->delete( $this->Input->json()->all() );
	}
}
