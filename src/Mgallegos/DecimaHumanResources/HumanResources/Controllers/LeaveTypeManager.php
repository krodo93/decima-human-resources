...
class LeaveTypeManager extends Controller {
	...
	*/
	...
	public function __construct(LeaveTypeManagementInterface $LeaveTypeManagerService,
	...
	{
		return $this->View->make('decima-human-resources::leave-type-management')
						->with('newLeaveTypeAction', $this->Session->get('newLeaveTypeAction', false))
						->with('editLeaveTypeAction', $this->Session->get('editLeaveTypeAction', false))
						->with('deleteLeaveTypeAction', $this->Session->get('deleteLeaveTypeAction', false))
						...
						//->with('accounts', $this->LeaveTypeManagerService->getGroupsAccounts())

	}

	public function postGridData()
	{
		return $this->LeaveTypeManagerService->getGridData( $this->Input->all() );
	}

	public function postCreate()
	{
		return $this->LeaveTypeManagerService->create( $this->Input->json()->all() );
	}

	public function postUpdate()
	{
		return $this->LeaveTypeManagerService->update( $this->Input->json()->all() );
	}

	public function postDelete()
	{
		return $this->LeaveTypeManagerService->delete( $this->Input->json()->all() );
	}
}
