...
class EloquentHolidayGridRepository extends EloquentRepositoryAbstract {
	...
	public function __construct(DatabaseManager $DB, AuthenticationManagementInterface $AuthenticationManager)
	{
		...
		$this->visibleColumns = array('t1.id AS hr_hm_id',
		 															't1.year AS hr_hm_year',
																	't1.date AS hr_hm_date',
																	't1.description AS hr_hm_description',
